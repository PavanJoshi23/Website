        ...
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          ...
          <AnimatedSection direction="right">
            <div className="relative flex justify-center">
              {/* Decorative blob */}
              <div className="absolute inset-0 bg-gradient-to-br from-primary-100 to-accent-300/20 rounded-3xl rotate-3 scale-105" />

              <div className="relative p-1 rounded-3xl bg-gradient-to-br from-primary-400 via-accent-400 to-primary-300 shadow-soft-lg">
                <div className="w-full aspect-square max-w-sm rounded-[22px] bg-gradient-to-br from-primary-50 to-accent-300/20 flex items-center justify-center overflow-hidden">
                  {personal.avatar ? (
                    <img src={personal.avatar} alt={personal.name} className="w-full h-full object-cover" />
                  ) : (
                    <div className="flex flex-col items-center gap-4 p-8">
                      <span className="text-9xl font-black text-primary-200 select-none leading-none">
            ...
            <AnimatedSection delay={0.3}>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-2">
                {stats.map((stat, i) => (
                  <div
                    key={i}
                    className="bg-surface-50 rounded-2xl p-4 text-center border border-surface-200 hover:border-primary-200 hover:bg-primary-50/50 transition-all duration-200"
                  >
